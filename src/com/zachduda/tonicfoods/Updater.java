...
// TonicFoods Async Check --> Benz56's update checker <3
...
public class Updater {
    ...
    private static final int ID = 72274;
            ...
            public void run() {
                Bukkit.getScheduler().runTaskAsynchronously(javaPlugin, () -> {
                    try {
                        ...
                        Bukkit.getConsoleSender().sendMessage("[TonicFoods] &cUnable to check for updates. Is your server online?");
                        cancel();
                        return;
                    }
                    ...
                    outdated = true;
                    Bukkit.getConsoleSender().sendMessage(ChatColor.translateAlternateColorCodes('&', "&r[TonicFoods] &e&lUpdate Available: &rYou're running &7v" + localPluginVersion + "&r, while the latest is &a" + outdatedversion));
